<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OriginalRSNPrintout.aspx.cs" Inherits="AutoRSN.OriginalRSNPrintout" %>
...
<body style="margin: 0px; padding:0px;">
    ...
    <div class="auto-style1">
       ...
       <asp:Image runat="server" ImageUrl="~/Resources/logo.png" id="logo" class="auto-style2" Width="133px" Height="47px" CssClass="auto-style161" />
        ...
        <span class="auto-style161">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>
        15 &amp; 16 , Jalan Hi-Tech 2/3 Phase 1,Kulim, Hi-Tech Park,09000 Kulim , Kedah , Malaysia.</strong><br />
        <br />
        </span>
        <strong><span class="auto-style161">REQUEST SHIPMENT NOTICE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Attn to Shipping /Logistics
        <br />
        </span>
        <table border="0" class ="auto-style160">
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style17">
                    <asp:CheckBox ID="CheckBox1" runat="server" Text="Bill to recipeint " TextAlign="Left" />
                </td>
        ...
        <table border="1" class="auto-style103">
            <tr>
                <td class="auto-style37" rowspan="6"><strong><span class="auto-style161">8 &amp; 9 ) THE GOODS<br />
                    <br />
                    </span>
                    </strong>
                ...
                <td class="auto-style44"><strong><span class="auto-style161">BILL TO PARTY ( NAME &amp; ADDRESS)</span></strong><span class="auto-style159"></td>
              
                <td class="auto-style52"></span><strong><span class="auto-style161">10) SHIP TO PARTY ( NAME &amp; ADDRESS) </span> </strong></td>
        ...
        &nbsp;<table runat="server" border="1" class="auto-style160" id="ItemID">
            <tr>
                <td class="auto-style91">(13)<br />
                    PO#</td>
                <td class="auto-style55">(14)<br />
                    SO# / Line# </td>
                <td class="auto-style134">(15)<br />
                    CUSTOMER<br />
                    PART NO.<br />
                    (CPN )</td>
                <td class="auto-style57">(16)<br />
                    DESCRIPTION</td>
                <td class="auto-style91">(17)<br />
                    COUNTRY OF<br />
                    ORIGIN </td>
                <td class="auto-style92">(18)<br />
                    FROM
                    <br />
                    ORIGIN </td>
                <td class="auto-style65">(19)<br />
                    IN-HOUSE<br />
                    BOM P/N</td>
                <td class="auto-style61">(20)<br />
                    QTY<br />
                    SHIP</td>
                <td class="auto-style142">(21)<br />
                    UOM</td>
                <td class="auto-style141">(22)<br />
                    UNIT
                    <br />
                    PRICE<br />
                </td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                <td colspan="4" class="auto-style149"><strong>28) REMARKS /SPECIAL INSTRUCTION
                    ...
                    <br />
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <em>
                   <asp:Label runat="server" ID="remarksLbl">dsadwdwddw</asp:Label>
                      </em>
                    <br />
                      <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td class="auto-style129" colspan="2"><strong>31) APPROVED BY :<br />
                    <br />
&nbsp;&nbsp;
                ...
                <td class="auto-style129" colspan="2" ><strong>32) SERVICE TYPE :
...
&nbsp;&nbsp;&nbsp;
                    ...
                    <br />
                    REASON :___________________<br />
                    APPROVED BY :__________________( Manager&#39;s name &amp; signature) </strong> </td>
                <td class="auto-style129" colspan="7"><strong>FOR LOGISTICS INTERNAL USE :<br />
